<!-- Working copy for the Markets page-plan structure (06 Jul 2026).
     Source draft: Copy & Content/automotive-rfid-tire-tags.md — treat THIS file as the working copy going forward. -->
---
title: "RFID Tire Tags for Connected Vehicles"
slug: rfid-tire-tags
...
# RFID Tire Tags for Connected Vehicles

**Automotive · RFID Tire Tags**
...
- **Materials and encapsulation** — rubber-compatible materials and encapsulation that take the heat and pressure of the cure.
...
Process depth sits on the capability page: RFID & Smart Tags owns the full inlay, card and tag range this build sits inside, and the antenna work common to all of them.

**[Explore RFID & Smart Tags →](/capabilities/rfid-smart-tags)**
...
**How is a tire tag built to take being embedded in a tire?**
From rubber-compatible materials, encapsulated to take the heat and pressure of vulcanization and to flex with the tire in service. Read performance after cure can be verified as part of the build.

**What can a tire RFID tag be used for?**
A unique ID lets a tire be tracked from the plant through fitment, service, retread and recycling — supporting inventory, warranty and life-cycle management.

**Does Hana have RFID manufacturing experience?**
Yes. Hana has manufactured and designed RFID products for more than twenty years, including inlays, smart tags and embeddable tags, on automated lines in China and the USA.
...
<!-- VERIFY BEFORE PUBLISH (hand to Hana ops / Thang):
  - Tire-tag (vs. general RFID inlay) production status, and which sites run it.
  - UHF / HF frequency support for tire tags.
  - Whether to name any specific durability or read-range spec.
