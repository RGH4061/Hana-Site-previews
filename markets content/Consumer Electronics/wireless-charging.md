<!-- Product page (sub-page) — drafted to the Automotive spoke prose model.
     ...
     CONSUMER RULE: no customer names and nothing brand-identifying. -->
---
title: "Wireless Charging Module Assembly"
...
meta_description: "Hana assembles wireless charging modules — coil winding, PCBA and box build through to a finished, functionally tested unit, at consumer volume."
keywords: "wireless charging module assembly, coil winding manufacturer, wireless charger contract manufacturer, charging pad assembly, wireless charging EMS"
---

# Wireless charging module assembly
...
**What does a wireless charging module consist of?**
As Hana builds it: a wound coil, the driver and control PCBA behind it, and the mechanical assembly that holds the two together — supplied as a module or as a finished, enclosed unit.

**What devices can Hana build charging modules for?**
...
<!-- VERIFY BEFORE PUBLISH (hand to Hana ops):
  - ⚑ Qi / WPC — DECIDED (Rupert, Jul 2026): Hana is **not Qi certified** but **does build in
    compliance with the standard**, so the claim is now IN copy, in the "What we build" bullet and a
    dedicated FAQ. The wording deliberately draws the distinction — "built in compliance with the Qi
    (WPC) standard", and "Hana is not itself a certification holder; for a finished consumer product
    certification is held by the product owner". This is both accurate and the normal EMS position.
    It must NEVER become "Qi certified", "WPC certified" or "Qi approved". Confirm the
    product-owner-holds-certification framing matches how Hana explains it to customers.
  - ⚑ Cheongju (South Korea) carries "wireless charging power module R&D" in the
    locations plan, but South Korea is excluded site-wide (operates under a different
    company name). Deliberately NOT referenced here. Confirm that exclusion holds.
  - ⚑ Coil sourcing framing: softened Jul 2026 from "Most contract manufacturers buy the coil in"
    (an unverifiable competitor-relative claim) to "The coil is often bought in and joined to the
    board later". Keeps the in-house-coil differentiator without a claim about competitors.
    Restore the stronger wording only if Hana wants to stand behind it.
    Confirm it is safe to state, or soften to "coil winding is often bought in".
  - Coil winding / coil assembly as a named group capability — confirm which sites
    actually wind coils (copy currently implies Cambodia and China).
  ...
  - CANONICAL: this page is the canonical wireless-charging page. Keep
    /markets/medical/wireless-charging/ pointing here and medical-specific.
